playState = {
    ...
    leff = game.add.button(0,400, "left",null,this,0,1,2);
    ...
    rayt = game.add.button(570,400, "right",null,this,3,4,5);
    ...
    if(game.physics.arcade.collide(material,base)){
        gameovertext = game.add.text(400,290,"Game Over!!",{fill:'yellow',font:'50px Times New Roman'}); 
        ...
        menubtn = game.add.button(405,400, 'menubtn', this.simula);                                                                      
        menubtn.anchor.setTo(0.5,0.5);
        menubtn.scale.setTo(0.6,0.6);
        game.input.onTap.add(this.simula);
    }
	},
	laro: function(){
            bg.visible = false;
